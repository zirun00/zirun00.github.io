    ...
    a.supersized = function (b) {
        ...
        d._build = function () {
            ...
            while (g <= d.options.slides.length - 1) {
                ...
                if (g == d.options.start_slide - 1) {
                    ...
                    if (d.options.thumb_links) {
                        ...
                        f = f + '<li class="thumb' + g + ' current-thumb"><img src="' +
                            i + '"/></li>'
                    }
                } else {
            ...
            if (d.options.thumbnail_navigation) {
                vars.current_slide -
                1 < 0 ? prevThumb = d.options.slides.length - 1 : prevThumb = vars.current_slide - 1;
        ...
        d.launch = function () {
            ...
            if (d.options.slide_links)a(vars.slide_list + "> li").click(function () {
                index = a(vars.slide_list + "> li").index(this);
                targetSlide = index + 1;
                d.goTo(targetSlide);
                return false
            });
            if (d.options.thumb_links)a(vars.thumb_list + "> li").click(function () {
                index = a(vars.thumb_list + "> li").index(this);
                targetSlide = index + 1;
                api.goTo(targetSlide);
                return false
            });
            if (d.options.slideshow &&
        ...
        d.resizeNow = function () {
            return d.$el.each(function () {
                a("img", d.el).each(function () {
                    ...
                    var e = d.$el.width(), h = d.$el.height(),
                        i;
                    if (d.options.fit_always)if (h / e > f)g(); else j(); else if (h <= d.options.min_height && e <= d.options.min_width)if (h / e > f)d.options.fit_landscape && f < 1 ? g(true) : j(true); else d.options.fit_portrait && f >= 1 ? j(true) : g(true); else if (e <= d.options.min_width)if (h / e > f)d.options.fit_landscape && f < 1 ? g(true) : j(); else d.options.fit_portrait && f >= 1 ? j() : g(true); else if (h <= d.options.min_height)if (h / e > f)d.options.fit_landscape && f < 1 ? g() : j(true); else d.options.fit_portrait && f >= 1 ? j(true) : g(); else if (h / e > f)d.options.fit_landscape &&
                    f < 1 ? g() : j(); else d.options.fit_portrait && f >= 1 ? j() : g();
                    function g(k) {
                        if (k) {
                            if (thisSlide.width() < e || thisSlide.width() < d.options.min_width)if (thisSlide.width() * f >= d.options.min_height) {
                                thisSlide.width(d.options.min_width);
                                thisSlide.height(thisSlide.width() * f)
                            } else j()
                        } else if (d.options.min_height >= h && !d.options.fit_landscape)if (e * f >= d.options.min_height || e * f >= d.options.min_height && f <= 1) {
                            thisSlide.width(e);
                    ...
                    function j(k) {
                        if (k) {
                            if (thisSlide.height() < h)if (thisSlide.height() / f >= d.options.min_width) {
                                thisSlide.height(d.options.min_height);
                                thisSlide.width(thisSlide.height() / f)
                            } else g(true)
                        } else if (d.options.min_width >= e)if (h / f >= d.options.min_width || f > 1) {
                            thisSlide.height(h);
                            thisSlide.width(h / f)
                        } else {
                            if (f <= 1) {
        ...
        d.nextSlide = function () {
            if (vars.in_animation || !api.options.slideshow)return false; else vars.in_animation =
                true;
            clearInterval(vars.slideshow_interval);
            ...
            loadSlide = false;
            vars.current_slide == d.options.slides.length - 1 ? loadSlide = 0 : loadSlide =
        ...
        d.prevSlide = function () {
            ...
            var g = a(d.el + " li:eq(" +
                vars.current_slide + ")"), i = d.$el.find(".prevslide");
            if (d.options.performance == 1)d.$el.removeClass("quality").addClass("speed");
            ...
            if (!a(k).html()) {
                ...
                imageLink = d.options.slides[loadSlide].url ? "href='" + d.options.slides[loadSlide].url + "'" : "";
                var f = a('<img src="' + d.options.slides[loadSlide].image + '"/>');
                f.appendTo(k).wrap("<a " + imageLink + j + "></a>").parent().parent().addClass("image-loading").css("visibility",
                    "hidden");
                f.load(function () {
                    d._origDim(a(this));
                    d.resizeNow()
            ...
            switch (d.options.transition) {
                ...
                case "carouselRight":
                    ...
                    e.animate({left: 0}, 0).animate({left: d.$el.width(), avoidTransforms: false},
        ...
        d.playToggle = function () {
            ...
            if (vars.is_paused) {
                ...
                if (typeof theme != "undefined" && typeof theme.playToggle ==
        ...
        d.goTo = function (f) {
            ...
            f = e - f + 1;
            clearInterval(vars.slideshow_interval);
            if (typeof theme != "undefined" && typeof theme.goTo ==
                "function")theme.goTo();
            ...
            if (d.options.slide_links) {
                ...
                a(vars.slide_list + "> li").eq(e -
                    f).addClass("current-slide")
            }
            if (d.options.thumb_links) {
        ...
        d.afterAnimation = function () {
            ...
            if (typeof theme != "undefined" && typeof theme.afterAnimation ==
    ...
    theme = {
        _init: function () {
            ...
            if (api.options.autoplay) {
                ...
                if (api.options.progress_bar)a(vars.progress_bar).stop().animate({left: -a(window).width()}, 0)
            }
            ...
            if (a(vars.slide_total).length)a(vars.slide_total).html(api.options.slides.length);
            if (api.options.thumb_links) {
                if (a(vars.thumb_list).width() <= a(vars.thumb_tray).width())a(vars.thumb_back + "," + vars.thumb_forward).fadeOut(0);
                ...
                a(vars.thumb_forward).click(function () {
                    if (vars.thumb_page - vars.thumb_interval <= -a(vars.thumb_list).width()) {
                        vars.thumb_page = 0;
                        a(vars.thumb_list).stop().animate({left: vars.thumb_page}, {
                            duration: 500,
                            easing: "easeOutExpo"
                        })
                    } else {
            ...
            if (jQuery.support.opacity)a(vars.prev_slide + "," + vars.next_slide).mouseover(function () {
            ...
            if (api.options.mouse_scrub)a(vars.thumb_tray).mousemove(function (f) {
            ...
            a(window).resize(function () {
                ...
                if (api.options.thumb_links && vars.thumb_tray.length) {
                    ...
                    } else a(vars.thumb_back + "," + vars.thumb_forward).fadeOut("fast")
                }
            })
        }, goTo: function (b) {
            if (api.options.progress_bar && !vars.is_paused) {
                a(vars.progress_bar).stop().animate({left: -a(window).width()},
                    0);
                theme.progressBar()
            }
            ...
            if (b == "play") {
                ...
                if (a(vars.play_button).attr("src"))a(vars.play_button).attr("src", vars.image_path + "play.png");
                if (api.options.progress_bar && vars.is_paused)a(vars.progress_bar).stop().animate({left: -a(window).width()}, 0)
            }
            ...
            if (api.options.thumb_links) {
                ...
                if (a(vars.thumb_list).width() > a(vars.thumb_tray).width())if (b ==
                    "next")if (vars.current_slide == 0) {
                    vars.thumb_page = 0;
                ...
                } else if (b == "prev")if (vars.current_slide == api.options.slides.length - 1) {
                    vars.thumb_page = Math.floor(a(vars.thumb_list).width() /
                            vars.thumb_interval) * -vars.thumb_interval;
                    if (a(vars.thumb_list).width() <= -vars.thumb_page)vars.thumb_page = vars.thumb_page + vars.thumb_interval;
                    a(vars.thumb_list).stop().animate({left: vars.thumb_page}, {duration: 500, easing: "easeOutExpo"})
